                    ...
                    <div class="tt-cart-content">
                        <div class="tt-cart-list">
                            <div class="tt-item">
                                <a href="product.html">
                                    <div class="tt-item-img">
                                        <img src="{{ asset('assets/client/wookie/app-assets/images/loader.svg') }}" data-src="{{ asset('assets/client/wookie/app-assets/images/skin-lingerie/product/product-06.jpg') }}" alt="">
                                    </div>
                            ...
                            <div class="tt-item">
                                <a href="product.html">
                                    <div class="tt-item-img">
                                        <img src="{{ asset('assets/client/wookie/app-assets/images/loader.svg') }}" data-src="{{ asset('assets/client/wookie/app-assets/images/skin-lingerie/product/product-07.jpg') }}" alt="">
                                    </div>
                                    <div class="tt-item-descriptions">
                                        <h2 class="tt-title">Flared Shift Dress</h2>
                                        <ul class="tt-add-info">
