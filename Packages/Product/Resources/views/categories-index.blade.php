...
@section('content')
    <div class="container-fluid">
        <div class="row">
            <div class="col-md-12">
                ...
                @slot('title', trans('product::product.categories'))
                @slot('notForm', true)
                @slot('content')
                    ...
                    @component('theme::components.layouts.list')
                        ...
                        @slot('btnNew')
                            ...
                            @slot('label', '<i class="fi fi-file-add"></i> '. trans('theme::theme.action.add'). ' '. trans('product::product.category'))
    ...
    @slot('title', trans('theme::theme.action.add'). ' '. trans('product::product.category'))
    ...
    <form class="form-horizontal" action="#" id="category-form">
        ...
        <div class="form-group row">
            <div class="col-md-12">
                @component('theme::components.field')
                @slot('title', trans('theme::theme.parent'). ' '. trans('product::product.category') )
                @slot('name', 'parent_id')
                @slot('type', 'dropdown')
                @slot('class', 'active')
...
@section('scripts')
    ...
    <script>
        let api = {
            cat: {
                ...
                get: '{{ route('product.category.get', '') }}',
                update: '{{ route('product.category.update', '') }}',
    ...
    <script src="{{ asset('packages/product/assets/js/category.crud.js')}}"></script>
@endsection