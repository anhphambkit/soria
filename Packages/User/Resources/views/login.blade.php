...
<head>
    <meta charset="utf-8" />
    <title>Backend Application - Login</title>
    ...
    <link href="{{ asset('packages/theme/vendors/css/style.css')}}" rel="stylesheet" type="text/css" />
</head>
<body>
<div id="wrapper">
    <div class="accountbg" style="background: url('http://coderthemes.com/highdmin/default/assets/images/bg-1.jpg');background-size: cover;"></div>
                    ...
                    <div class="card-box p-5">
                        <h2 class="text-uppercase text-center pb-4">
                            <a href="index.html" class="text-success">
                                <span><img src="http://coderthemes.com/highdmin/default/assets/images/logo.png" alt="" height="26"></span>
                            </a>
                        </h2>
                        <form class="" action="{{ route('login') }}" method="POST">
                            ...
                            <div class="form-group m-b-20 row">
                                <div class="col-12">
                                    ...
                                    <input class="form-control{{ $errors->has('email')?' is-invalid':'' }}" type="email" id="emailaddress" required="" name="email" placeholder="Enter your email">
                                    @if ($errors->has('email'))
                            ...
                            <div class="form-group row m-b-20">
                                <div class="col-12">
                                    ...
                                    <input class="form-control{{ $errors->has('email')?' is-invalid':'' }}" name="password" type="password" required="" id="password" placeholder="Enter your password">
