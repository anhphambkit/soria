...
class MakeMiniCrud extends Command
{
     ...
     * @var string
     */
    protected $description = '[Eden] Make a mini crud template.';
    ...
    public function handle() {
        ...
        $coreServices->exportTemplate($coreServices->packagePath('Core'). '/Publication/MiniCrud', $coreServices->packagePath($package). '/', [ 'package' => $package, 'model'  => $model ]);
    }
}